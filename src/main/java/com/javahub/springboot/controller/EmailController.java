...
import com.javahub.springboot.service.EmailService;
...
public class EmailController{
	...
	public ModelAndView textEmail(Contact contact) {
		ModelAndView mav = new ModelAndView("user/text-email");
	...
	public ModelAndView attachmentEmail(Contact contact) {
		ModelAndView mav = new ModelAndView("user/attachment-email");
