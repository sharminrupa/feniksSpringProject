...
<jsp:include page="layout/header.jsp"/>
	...
	<div class="text-center py-5">
		<h3>This is a feniks employee access page</h3><br>
	...
	<section class="signup m-5">
				...
				<form:form action="search"  method="POST" class="d-flex">
                 <input type="text" class="form-control" placeholder="Employee Id" required="required" name="empId" />
				...
				<table border="1" style="border: 1px solid black;" class="table table-bordered table-striped table-hover">
					<tr class="bg-primary">
						<th>Sr.No</th>
						<th>Fname</th>
						<th>Lname</th>
